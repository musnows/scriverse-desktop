...
Scriverse Desktop 是 Scriverse 的 Electron 桌面客户端，当前版本为 `1.0.6`。仓库只维护桌面壳、本地工作区编排、远端 Server 连接、软件内登录、本地 AI、离线同步和打包安装能力。
...
- 从 Desktop `1.0.1` 版本开始，Desktop 与 Scriverse Server 使用相同的版本号；当前 `1.0.6` Desktop 对应 `1.0.6` Server。
